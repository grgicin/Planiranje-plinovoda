public class VodovodnaTocka {
    ...
    public VodovodnaTocka(int idVodovodneTocke, double latutude, double longitude, int poredVodovod, String komentar, int idVodovod, int idTipVodovodneTocke) {
        this.idVodovodneTocke = idVodovodneTocke;
        this.latutude = latutude;
        this.longitude = longitude;
        this.poredVodovod = poredVodovod;
